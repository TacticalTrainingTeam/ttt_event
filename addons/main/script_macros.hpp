...
#undef PREP
    ...
    #define PREP_RECOMPILE_START    if (isNil "ttt_event_fnc_recompile") then {ttt_event_recompiles = []; ttt_event_fnc_recompile = {{call _x} forEach ttt_event_recompiles;}}; private _recomp = {
    #define PREP_RECOMPILE_END      }; call _recomp; ttt_event_recompiles pushBack _recomp;
#else
