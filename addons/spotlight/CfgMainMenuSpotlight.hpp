class CfgMainMenuSpotlight { // RscDisplayMain >> Spotlight works but is considered obsolete since SPOTREP #00064
    class spotlight_event {
        ...
        picture = QPATHTOEF(common,data\ui\ttt_logo_co.paa); // Square picture, ideally 512x512
        //video = "\a3\Ui_f\Video\spotlight_1_Apex.ogv"; // Video played on mouse hover
        action = QUOTE(ARR_3([_this,'game.tacticalteam.de',2382]) call (uiNamespace getVariable QQEFUNC(common,join)));
